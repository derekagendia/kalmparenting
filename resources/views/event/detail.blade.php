                ...
                <div class="col-md-6 order-md-0 pt-6 pt-md-10 pb-12 pb-md-13 text-center text-md-start">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb bg-transparent">
                            ...
                            <li class="breadcrumb-item text-white fw-bold "><a href="event.html">Event</a></li>
                            <li class="breadcrumb-item text-white fw-bold active" aria-current="page">Event details</li>
                        </ol>
                    </nav>
